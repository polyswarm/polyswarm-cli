...
@click.pass_context
@polyswarm.client.utils.any_provided('url', 'url_file')
...
@click.pass_context
@polyswarm.client.utils.any_provided('hash_value', 'hash_file')
...
@click.option('-s', '--scan-config', type=click.STRING, default=None,
              help='Configuration template to be used in the scan. E.g.: "default", "more-time", "most-time".')
@click.argument('scan_id', nargs=-1, callback=polyswarm.client.utils.validate_id, required=True)
@click.pass_context
...
@click.argument('scan_id', nargs=-1, callback=polyswarm.client.utils.validate_id)
@click.pass_context
@polyswarm.client.utils.any_provided('scan_id', 'scan_id_file')
