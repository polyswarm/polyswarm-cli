result: "Successfully deleted Hunt:\nHunt Id: 3220090199138422\nStatus: DELETING\n\
  ...
  \       More generic - match just the embedded EICAR string (e.g. in packed executables,\
  \ PDFs, etc)\n    */\n\n    meta:\n        description = \"Standard AV test, checking\
  \ for an EICAR substring\"\n        author = \"Austin Byers | Airbnb CSIRT\"\n\n\
