result: '{"account_number": "111", "archives_in_flight": 0, "archives_scanned": 0,
  "archives_total": 0, "communities": ["gamma"], "created": "2026-08-25T18:25:52.397034+00:00",
  "failed_max_retries": 0, "failed_other": 0, "id": "32808041501095355", "progress":
  null, "results_csv_uri": null, "rule_id": null, "rule_modified": null, "ruleset_name":
  null, "source_rule_changed": null, "status": "DELETING", "summary": null, "user_account_number":
  "111", "yara": "rule eicar_av_test : eicar match {\n    /*\n       Per standard,
  match only if entire file is EICAR string plus optional trailing whitespace.\n       The
