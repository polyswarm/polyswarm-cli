...
class LiveHuntTest(BaseTestCase):
    ...
    def test_live_hunt_create_json(self):
        with patch('polyswarm_api.api.PolyswarmAPI.live_create', return_value=resources.hunts()[0]):
            result = self._run_cli(['--output-format', 'json',
    ...
    def test_live_hunt_delete_json(self):
        with patch('polyswarm_api.api.PolyswarmAPI.live_delete', return_value=resources.hunts()[0]):
            result = self._run_cli(['--output-format', 'json',
    ...
    def test_live_hunt_list_json(self):
        with patch('polyswarm_api.api.PolyswarmAPI.live_list', return_value=[resources.hunts()[0]]):
            result = self._run_cli(['--output-format', 'json',
                                    'live', 'list'])
        self._assert_json_result(
            result,
...
class HistoricalHuntTest(BaseTestCase):
    ...
    def test_historical_hunt_delete_json(self):
        with patch('polyswarm_api.api.PolyswarmAPI.historical_delete', return_value=resources.hunts()[0]):
            result = self._run_cli(['--output-format', 'json',
    ...
    def test_historical_hunt_list_json(self):
        with patch('polyswarm_api.api.PolyswarmAPI.historical_list', return_value=[resources.hunts()[0]]):
            result = self._run_cli(['--output-format', 'json',
                                    'historical', 'list'])
        self._assert_json_result(
            result,
